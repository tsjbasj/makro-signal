...
const POSITIONS = [
  { ticker: 'OXY',  name: 'Occidental Petroleum', shares: 29,  buy: 57.90,  stop: 46,  target: 68,  dkk: 12000 },
...
const INITIAL_TRADES: Trade[] = [
  { date: '17/03/2026', ticker: 'OXY',  action: 'KØB', shares: 29,  price: 57.90,  dkk: 12000 },
